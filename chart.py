...
"""
from PyHighcharts.options import *
from PyHighcharts.highchart_types import *
from PyHighcharts.common import *
...
# Static Vars
SHOW_TEMPLATE  = os.path.dirname(__file__)+"\\show_temp.tmp"
BASE_TEMPLATE  = os.path.dirname(__file__)+"\\base.tmp"
GECKO_TEMPLATE = os.path.dirname(__file__)+"\\gecko_temp.tmp"
...
class Highchart(object):
    ...
    def show(self):
        ...
        new_fn = expanduser("~") + "\\" + new_filename
